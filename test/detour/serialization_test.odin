...
test_navmesh_file_serialization :: proc(t: ^testing.T) {
    ...
    file_info, stat_err := os.stat(navmesh_file)
    testing.expect(t, stat_err == os.ERROR_NONE, "Navigation mesh file should exist")
    testing.expect(t, file_info.size > 0, "Navigation mesh file should not be empty")
