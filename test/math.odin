...
test_overlap_bounds :: proc(t: ^testing.T) {
  ...
  testing.expect(
    t,
    geometry.overlap_bounds(amin1, amax1, bmin1, bmax1),
  ...
  testing.expect(
    t,
    !geometry.overlap_bounds(amin1, amax1, bmin2, bmax2),
  ...
  testing.expect(
    t,
    geometry.overlap_bounds(amin1, amax1, bmin3, bmax3),
...
test_overlap_quantized_bounds :: proc(t: ^testing.T) {
  ...
  testing.expect(
    t,
    geometry.overlap_quantized_bounds(amin1, amax1, bmin1, bmax1),
  ...
  testing.expect(
    t,
    !geometry.overlap_quantized_bounds(amin1, amax1, bmin2, bmax2),
...
test_point_in_polygon_2d :: proc(t: ^testing.T) {
  ...
  testing.expect(
    t,
    geometry.point_in_polygon_2d(pt_inside, square),
  ...
  testing.expect(
    t,
    !geometry.point_in_polygon_2d(pt_outside, square),
  ...
  testing.expect(
    t,
    !geometry.point_in_polygon_2d(pt_vertex, square),
...
test_overlap_circle_segment :: proc(t: ^testing.T) {
  ...
  testing.expect(
    t,
    geometry.overlap_circle_segment(center, radius, p1, q1),
  ...
  testing.expect(
    t,
    !geometry.overlap_circle_segment(center, radius, p2, q2),
  ...
  testing.expect(
    t,
    geometry.overlap_circle_segment(center, radius, p3, q3),
...
test_next_pow2 :: proc(t: ^testing.T) {
  testing.expect_value(t, alg.next_pow2(0), u32(0))
  testing.expect_value(t, alg.next_pow2(1), u32(1))
  testing.expect_value(t, alg.next_pow2(2), u32(2))
  testing.expect_value(t, alg.next_pow2(3), u32(4))
  testing.expect_value(t, alg.next_pow2(5), u32(8))
  testing.expect_value(t, alg.next_pow2(16), u32(16))
  testing.expect_value(t, alg.next_pow2(17), u32(32))
  testing.expect_value(t, alg.next_pow2(1000), u32(1024))
}

@(test)
test_ilog2 :: proc(t: ^testing.T) {
  testing.expect_value(t, alg.ilog2(1), u32(0))
  testing.expect_value(t, alg.ilog2(2), u32(1))
  testing.expect_value(t, alg.ilog2(4), u32(2))
  testing.expect_value(t, alg.ilog2(8), u32(3))
  testing.expect_value(t, alg.ilog2(16), u32(4))
  testing.expect_value(t, alg.ilog2(31), u32(4))
  testing.expect_value(t, alg.ilog2(32), u32(5))
  testing.expect_value(t, alg.ilog2(1024), u32(10))
}

@(test)
test_align :: proc(t: ^testing.T) {
  testing.expect_value(t, alg.align(0, 4), 0)
  testing.expect_value(t, alg.align(1, 4), 4)
  testing.expect_value(t, alg.align(3, 4), 4)
  testing.expect_value(t, alg.align(4, 4), 4)
  testing.expect_value(t, alg.align(5, 4), 8)
  testing.expect_value(t, alg.align(15, 8), 16)
  testing.expect_value(t, alg.align(16, 8), 16)
}
...
test_overlap_bounds_2d :: proc(t: ^testing.T) {
  ...
  testing.expect(
    t,
    geometry.overlap_bounds_2d(amin1, amax1, bmin1, bmax1),
  ...
  testing.expect(
    t,
    !geometry.overlap_bounds_2d(amin1, amax1, bmin2, bmax2),
  ...
  testing.expect(
    t,
    !geometry.overlap_bounds_2d(amin1, amax1, bmin3, bmax3),
  ...
  testing.expect(
    t,
    geometry.overlap_bounds_2d(amin1, amax1, bmin4, bmax4),
  ...
  testing.expect(
    t,
    geometry.overlap_bounds_2d(amin1, amax1, bmin5, bmax5),
...
test_between :: proc(t: ^testing.T) {
  ...
  testing.expect(
    t,
    geometry.between(a, b, c),
    "Point should be between endpoints",
  )
  testing.expect(
    t,
    geometry.between(b, a, c),
  ...
  testing.expect(
    t,
    !geometry.between(a, b, d),
    "Point beyond segment should not be between",
  )
  e := [2]i32{-5, 0}
  testing.expect(
    t,
    !geometry.between(a, b, e),
...
test_intersect_prop :: proc(t: ^testing.T) {
  ...
  testing.expect(
    t,
    geometry.intersect_prop(a, b, c, d),
  ...
  testing.expect(
    t,
    !geometry.intersect_prop(e, f, g, h),
  ...
  testing.expect(
    t,
    !geometry.intersect_prop(i, j, k, l),
  ...
  testing.expect(
    t,
    !geometry.intersect_prop(m, n, o, p),
...
test_in_cone :: proc(t: ^testing.T) {
  ...
  testing.expect(
    t,
    geometry.in_cone(a0, a1, a2, p_inside),
  ...
  testing.expect(
    t,
    !geometry.in_cone(a0, a1, a2, p_outside),
  ...
  testing.expect(
    t,
    geometry.in_cone(a0_r, a1_r, a2_r, p_reflex_inside),
...
test_offset_poly :: proc(t: ^testing.T) {
  // Test 1: Simple square polygon (clockwise winding for proper inset)
  {
    ...
    out_verts, ok := geometry.offset_poly_2d(verts, 0.5)
  ...
  // Test 4: Edge case - offset too large
  {
    ...
    out_verts, ok := geometry.offset_poly_2d(verts, 5.0)
    defer delete(out_verts)
  ...
  {
    verts: [][3]f32
    out_verts, ok := geometry.offset_poly_2d(verts, 0.1)
    defer delete(out_verts)
