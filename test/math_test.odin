...
test_next_prev_dir :: proc(t: ^testing.T) {
    ...
    testing.expect_value(t, nav_recast.next_dir(0), 1)
    testing.expect_value(t, nav_recast.next_dir(1), 2)
    testing.expect_value(t, nav_recast.next_dir(2), 3)
    testing.expect_value(t, nav_recast.next_dir(3), 0)

    // Test prev_dir wrapping
    testing.expect_value(t, nav_recast.prev_dir(0), 3)
    testing.expect_value(t, nav_recast.prev_dir(1), 0)
    testing.expect_value(t, nav_recast.prev_dir(2), 1)
    testing.expect_value(t, nav_recast.prev_dir(3), 2)
}

@(test)
test_quantize_float :: proc(t: ^testing.T) {
    v := [3]f32{1.2, 3.7, 5.1}
    result := nav_recast.quantize_float(v, 10.0)
    ...
    result2 := nav_recast.quantize_float(v2, 10.0)
...
test_overlap_bounds :: proc(t: ^testing.T) {
    ...
    testing.expect(t, nav_recast.overlap_bounds(amin1, amax1, bmin1, bmax1), "Bounds should overlap")

    // Test non-overlapping bounds
    bmin2 := [3]f32{15, 15, 15}
    bmax2 := [3]f32{20, 20, 20}

    testing.expect(t, !nav_recast.overlap_bounds(amin1, amax1, bmin2, bmax2), "Bounds should not overlap")

    // Test touching bounds (edge case)
    bmin3 := [3]f32{10, 10, 10}
    bmax3 := [3]f32{20, 20, 20}

    testing.expect(t, nav_recast.overlap_bounds(amin1, amax1, bmin3, bmax3), "Touching bounds should overlap")
}
...
test_overlap_quantized_bounds :: proc(t: ^testing.T) {
    ...
    testing.expect(t, nav_recast.overlap_quantized_bounds(amin1, amax1, bmin1, bmax1), "Quantized bounds should overlap")

    // Test non-overlapping quantized bounds
    bmin2 := [3]i32{15, 15, 15}
    bmax2 := [3]i32{20, 20, 20}

    testing.expect(t, !nav_recast.overlap_quantized_bounds(amin1, amax1, bmin2, bmax2), "Quantized bounds should not overlap")
}
...
test_triangle_area_2d :: proc(t: ^testing.T) {
    ...
    area := nav_recast.triangle_area_2d(a, b, c)
    testing.expect(t, approx_equal(area, 6.0), "Triangle area should be 6")
    area = nav_recast.triangle_area_2d(a, c, b)
    testing.expect(t, approx_equal(area, 6.0), "Triangle area should be 6")
    ...
    area2 := nav_recast.triangle_area_2d(d, e, f)
...
test_point_in_polygon_2d :: proc(t: ^testing.T) {
    ...
    testing.expect(t, nav_recast.point_in_polygon_2d(pt_inside, square), "Point should be inside square")

    // Test point outside
    pt_outside := [3]f32{15, 0, 15}
    testing.expect(t, !nav_recast.point_in_polygon_2d(pt_outside, square), "Point should be outside square")

    // Test point on edge
    pt_edge := [3]f32{5, 0, 0}
    edge_result := nav_recast.point_in_polygon_2d(pt_edge, square)
    if edge_result {
    ...
    testing.expect(t, !nav_recast.point_in_polygon_2d(pt_vertex, square), "Point on vertex should be considered outside")
    ...
    in_result := nav_recast.point_in_polygon_2d(pt_concave_in, concave)
    if !in_result {
    ...
    out_result := nav_recast.point_in_polygon_2d(pt_concave_out, concave)
    if out_result {
...
test_intersect_segment_triangle :: proc(t: ^testing.T) {
    ...
    hit1, t1 := nav_recast.intersect_segment_triangle(sp1, sq1, a, b, c)
    ...
    hit2, _ := nav_recast.intersect_segment_triangle(sp2, sq2, a, b, c)
    ...
    hit3, _ := nav_recast.intersect_segment_triangle(sp3, sq3, a, b, c)
    ...
    hit4, t4 := nav_recast.intersect_segment_triangle(sp4, sq4, a, b, c)
...
test_closest_point_on_triangle :: proc(t: ^testing.T) {
    ...
    p5 := [3]f32{2, 0, 2}
    closest5 := nav_recast.closest_point_on_triangle(p5, a, b, c)
...
test_calc_poly_normal :: proc(t: ^testing.T) {
    ...
    normal := nav_recast.calc_poly_normal(square)
    ...
    normal2 := nav_recast.calc_poly_normal(triangle)
...
test_poly_area_2d :: proc(t: ^testing.T) {
    ...
    area := nav_recast.poly_area_2d(square)
    ...
    area2 := nav_recast.poly_area_2d(triangle)
    ...
    area3 := nav_recast.poly_area_2d(square_cw)
...
test_intersect_segments_2d :: proc(t: ^testing.T) {
    ...
    hit1, s1, t1 := nav_recast.intersect_segments_2d(ap1, aq1, bp1, bq1)
    ...
    hit2, _, _ := nav_recast.intersect_segments_2d(ap2, aq2, bp2, bq2)
    ...
    hit3, _, _ := nav_recast.intersect_segments_2d(ap3, aq3, bp3, bq3)
...
test_overlap_circle_segment :: proc(t: ^testing.T) {
    ...
    testing.expect(t, nav_recast.overlap_circle_segment(center, radius, p1, q1), "Segment should overlap circle")

    // Test segment outside circle
    p2 := [3]f32{0, 0, 10}
    q2 := [3]f32{10, 0, 10}

    testing.expect(t, !nav_recast.overlap_circle_segment(center, radius, p2, q2), "Segment should not overlap circle")

    // Test segment tangent to circle
    p3 := [3]f32{0, 0, 8}
    q3 := [3]f32{10, 0, 8}

    testing.expect(t, nav_recast.overlap_circle_segment(center, radius, p3, q3), "Tangent segment should overlap circle")
}

@(test)
test_next_pow2 :: proc(t: ^testing.T) {
    testing.expect_value(t, nav_recast.next_pow2(0), u32(0))
    testing.expect_value(t, nav_recast.next_pow2(1), u32(1))
    testing.expect_value(t, nav_recast.next_pow2(2), u32(2))
    testing.expect_value(t, nav_recast.next_pow2(3), u32(4))
    testing.expect_value(t, nav_recast.next_pow2(5), u32(8))
    testing.expect_value(t, nav_recast.next_pow2(16), u32(16))
    testing.expect_value(t, nav_recast.next_pow2(17), u32(32))
    testing.expect_value(t, nav_recast.next_pow2(1000), u32(1024))
}

@(test)
test_ilog2 :: proc(t: ^testing.T) {
    testing.expect_value(t, nav_recast.ilog2(1), u32(0))
    testing.expect_value(t, nav_recast.ilog2(2), u32(1))
    testing.expect_value(t, nav_recast.ilog2(4), u32(2))
    testing.expect_value(t, nav_recast.ilog2(8), u32(3))
    testing.expect_value(t, nav_recast.ilog2(16), u32(4))
    testing.expect_value(t, nav_recast.ilog2(31), u32(4))
    testing.expect_value(t, nav_recast.ilog2(32), u32(5))
    testing.expect_value(t, nav_recast.ilog2(1024), u32(10))
}

@(test)
test_align :: proc(t: ^testing.T) {
    testing.expect_value(t, nav_recast.align(0, 4), 0)
    testing.expect_value(t, nav_recast.align(1, 4), 4)
    testing.expect_value(t, nav_recast.align(3, 4), 4)
    testing.expect_value(t, nav_recast.align(4, 4), 4)
    testing.expect_value(t, nav_recast.align(5, 4), 8)
    testing.expect_value(t, nav_recast.align(15, 8), 16)
    testing.expect_value(t, nav_recast.align(16, 8), 16)
}
