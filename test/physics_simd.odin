...
test_obb_to_aabb_batch4_identity :: proc(t: ^testing.T) {
  ...
  physics.obb_to_aabb_batch4(obbs, &result)
...
test_vector_cross3_batch4 :: proc(t: ^testing.T) {
  ...
  result := physics.vector_cross3_batch4(a, b)
...
test_quaternion_mul_vector3_batch4 :: proc(t: ^testing.T) {
  ...
  result := physics.quaternion_mul_vector3_batch4(q, v)
...
test_vector_dot3_batch4 :: proc(t: ^testing.T) {
  ...
  result := physics.vector_dot3_batch4(a, b)
...
test_vector_length3_batch4 :: proc(t: ^testing.T) {
  ...
  result := physics.vector_length3_batch4(v)
...
test_vector_normalize3_batch4 :: proc(t: ^testing.T) {
  ...
  result := physics.vector_normalize3_batch4(v)
...
// ============================================================================
// BENCHMARK COMPARISON TESTS (SIMD vs Scalar)
// ============================================================================
...
benchmark_vector_cross3 :: proc(t: ^testing.T) {
  ...
  data := new(Benchmark_Vector_Data)
  defer free(data)
  ...
  simd_proc :: proc(
    ...
    for i in 0 ..< options.rounds {
      for batch in &data_ptr.vectors_a {
        ...
        _ = physics.vector_cross3_batch4(
  ...
  input_bytes := slice.bytes_from_ptr(data, size_of(Benchmark_Vector_Data))
...
benchmark_quaternion_mul_vector3 :: proc(t: ^testing.T) {
  ...
  // Setup test data - use heap allocation to avoid stack overflow
  data := new(Benchmark_Quaternion_Data)
  defer free(data)
  ...
  simd_proc :: proc(
    ...
    data_ptr := cast(^Benchmark_Quaternion_Data)raw_data(options.input)
    for i in 0 ..< options.rounds {
      for idx in 0 ..< len(data_ptr.quaternions) {
        _ = physics.quaternion_mul_vector3_batch4(
  ...
  input_bytes := slice.bytes_from_ptr(data, size_of(Benchmark_Quaternion_Data))
...
benchmark_vector_length3 :: proc(t: ^testing.T) {
  ...
  simd_proc :: proc(
    ...
    for i in 0 ..< options.rounds {
      for idx in 0 ..< len(data_ptr.vectors_a) {
        _ = physics.vector_length3_batch4(data_ptr.vectors_a[idx])
        options.processed += 4 * size_of(f32)
      }
    }
    return nil
...
benchmark_vector_normalize3 :: proc(t: ^testing.T) {
  ...
  simd_proc :: proc(
    ...
    for i in 0 ..< options.rounds {
      for idx in 0 ..< len(data_ptr.vectors_a) {
        _ = physics.vector_normalize3_batch4(data_ptr.vectors_a[idx])
        options.processed += 4 * size_of([3]f32)
      }
    }
    return nil
...
test_aabb_intersects_batch4 :: proc(t: ^testing.T) {
  ...
  result := physics.aabb_intersects_batch4(a, b)
...
benchmark_obb_to_aabb :: proc(t: ^testing.T) {
  ...
  simd_proc :: proc(
    ...
    data_ptr := cast(^Benchmark_Obb_Data)raw_data(options.input)
    aabbs: [4]geometry.Aabb
    for i in 0 ..< options.rounds {
      for idx in 0 ..< len(data_ptr.obbs) {
        physics.obb_to_aabb_batch4(data_ptr.obbs[idx], &aabbs)
  ...
  input_bytes := slice.bytes_from_ptr(data, size_of(Benchmark_Obb_Data))
...
benchmark_aabb_intersects :: proc(t: ^testing.T) {
  ...
  input_bytes := slice.bytes_from_ptr(data, size_of(Benchmark_Aabb_Data))
