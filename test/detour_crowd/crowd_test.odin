...
test_crowd_creation_and_destruction :: proc(t: ^testing.T) {
    ...
    testing.expect(t, nav_recast.status_succeeded(status), "Failed to create crowd")
...
test_crowd_utility_functions :: proc(t: ^testing.T) {
    ...
    testing.expect(t, nav_recast.status_succeeded(set_status), "Failed to set obstacle avoidance params")
