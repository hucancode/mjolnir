...
test_sample_valid :: proc(t: ^testing.T) {
    ...
    result := animation.keyframe_sample(f32, frames, 0.5);
...
test_sample_one_data_point :: proc(t: ^testing.T) {
    ...
    result := animation.keyframe_sample(f32, frames, 0.0);
    testing.expect_value(t, result, 42.0);
    result = animation.keyframe_sample(f32, frames, 1.0);
    testing.expect_value(t, result, 42.0);
    result = animation.keyframe_sample(f32, frames, -1.0);
    testing.expect_value(t, result, 42.0);
}
...
test_sample_out_of_range :: proc(t: ^testing.T) {
    ...
    result1 := animation.keyframe_sample(f32, frames, -1.0);
    testing.expect_value(t, result1, 2.0);
    // After last keyframe
    result2 := animation.keyframe_sample(f32, frames, 2.0);
