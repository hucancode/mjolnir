...
// Depth-only vertex shader for occlusion culling depth pass
...
// Use same descriptor set layout as resources manager
...
layout(set = 3, binding = 0) readonly buffer MeshBuffer {
    MeshData meshes[];
};
...
layout(set = 4, binding = 0) readonly buffer VertexSkinningBuffer {
