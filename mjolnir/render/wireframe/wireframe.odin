...
SHADER_VERT :: #load("../../shader/wireframe/vert.spv")
SHADER_FRAG :: #load("../../shader/wireframe/frag.spv")
...
init :: proc(
	...
	log.info("Initializing wireframe renderer")
	...
	log.info("Wireframe pipeline initialized successfully")
	return .SUCCESS
}
