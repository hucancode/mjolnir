...
init :: proc(
	...
	vert_module := gpu.create_shader_module(gctx.device, SHADER_WIREFRAME_VERT) or_return
	defer vk.DestroyShaderModule(gctx.device, vert_module, nil)
	frag_module := gpu.create_shader_module(gctx.device, SHADER_WIREFRAME_FRAG) or_return
