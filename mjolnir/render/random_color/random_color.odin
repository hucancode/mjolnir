...
SHADER_VERT :: #load("../../shader/random_color/vert.spv")
SHADER_FRAG :: #load("../../shader/random_color/frag.spv")
...
init :: proc(
	...
	log.info("Initializing random_color renderer")
	...
	log.info("Random color pipeline initialized successfully")
	return .SUCCESS
}
