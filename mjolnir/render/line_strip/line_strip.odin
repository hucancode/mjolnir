...
SHADER_VERT :: #load("../../shader/line_strip/vert.spv")
SHADER_FRAG :: #load("../../shader/line_strip/frag.spv")
...
init :: proc(
	...
	log.info("Initializing line_strip renderer")
	...
	log.info("Line strip pipeline initialized successfully")
	return .SUCCESS
}
