...
SHADER_FRAG :: #load("../../../shader/grayscale/frag.spv")

// Effect configuration
Config :: struct {
	weights:  [3]f32, // RGB weights for grayscale conversion
	strength: f32,    // Blend factor (0.0 = original, 1.0 = full grayscale)
}
...
init :: proc(
	...
	log.info("Initializing grayscale effect pipeline...")
	...
	log.info("Grayscale effect pipeline initialized successfully")
	return .SUCCESS
}
...
// Add grayscale node to render graph
add_node :: proc(
	g: ^rg.Graph,
	renderer: ^Renderer,
	texture_manager: ^gpu.TextureManager,
	...
	pass := rg.add_pass(g, "grayscale", pass_execute, ctx_storage)
