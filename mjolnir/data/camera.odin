...
// NOTE: This function needs render.CameraGPU to access GPU buffers
// Consider moving to render module or adding a helper that takes CameraGPU
camera_get_visible_count :: proc(camera: ^Camera, frame_index: u32) -> u32 {
  // TODO: This needs to be refactored to use render.CameraGPU
...
// NOTE: The draw_list_source is now in render.CameraGPU, not in data.Camera
// This function should be called from the render module with access to CameraGPU
camera_use_external_draw_list :: proc(
  target_camera: ^Camera,
  source_camera: ^Camera,
) {
  // The actual draw_list_source assignment needs to happen in render module
  // We just disable the features here
...
// NOTE: This function needs render.SphericalCameraGPU to access GPU buffers
// Consider moving to render module or adding a helper that takes SphericalCameraGPU
spherical_camera_visible_count :: proc(
  camera: ^SphericalCamera,
  frame_index: u32,
) -> u32 {
  // TODO: This needs to be refactored to use render.SphericalCameraGPU
  // For now, return 0 as a placeholder
  return 0
}