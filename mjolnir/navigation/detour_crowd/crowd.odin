...
crowd_update :: proc(crowd: ^Crowd, dt: f32, debug_data: ^Crowd_Agent_Debug_Info) -> nav_recast.Status {
    if crowd == nil || dt <= 0 {
        return {.Invalid_Param}
    }
...
crowd_request_move_target :: proc(crowd: ^Crowd, agent_id: nav_recast.Agent_Id, 
