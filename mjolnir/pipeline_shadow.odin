  ...
  dynamic_state_info := vk.PipelineDynamicStateCreateInfo {
    ...
    for features in 0..<SHADOW_SHADER_VARIANT_COUNT {
        ...
        vertex_input_info := vk.PipelineVertexInputStateCreateInfo{
            ...
            vertexAttributeDescriptionCount = len(geometry.SIMPLE_VERTEX_ATTRIBUTE_DESCRIPTIONS),
            pVertexAttributeDescriptions = raw_data(geometry.SIMPLE_VERTEX_ATTRIBUTE_DESCRIPTIONS[:])
        }
